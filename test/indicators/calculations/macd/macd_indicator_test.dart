...
void main() {
  ...
  setUpAll(() {
    ...
    macdIndicator = MACDIndicator<MockResult>.fromIndicator(
      closeValueIndicator,
    );

    signalMACDIndicator = SignalMACDIndicator<MockResult>.fromIndicator(
      macdIndicator,
    );
  });
  ...
  group(' Moving Average Convergance Divergence Indicator tests', () {
    ...
    test(
      ...
      () {
        ...
        expect(
          macdIndicator1.getValue(36).quote,
          macdIndicator2.getValue(36).quote,
        );
