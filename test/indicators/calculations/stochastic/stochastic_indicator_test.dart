  ...
  group('Stochastic Indicator test.', () {
    test(
      ...
      () {
        ...
        expect(
          roundDouble(fastStochasticIndicator.getValue(21).quote, 2),
          69.98,
        );
        expect(
          roundDouble(fastStochasticIndicator.getValue(22).quote, 2),
          73.09,
        );
        expect(
          roundDouble(fastStochasticIndicator.getValue(23).quote, 2),
          73.45,
        );
        expect(
          roundDouble(fastStochasticIndicator.getValue(24).quote, 2),
          61.2,
        );
        expect(
          roundDouble(fastStochasticIndicator.getValue(25).quote, 2),
          60.92,
        );
        expect(
          roundDouble(fastStochasticIndicator.getValue(26).quote, 2),
          40.58,
        );
        expect(
          roundDouble(fastStochasticIndicator.getValue(27).quote, 2),
          40.58,
        );
        expect(
          roundDouble(fastStochasticIndicator.getValue(28).quote, 2),
          66.91,
        );
      },
    );
    ...
    test(
      ...
      () {
        ...
        smoothedFastStochasticIndicator =
            SmoothedFastStochasticIndicator<MockResult>(
              fastStochasticIndicator,
            );

        expect(
          roundDouble(smoothedFastStochasticIndicator.getValue(21).quote, 2),
          81.07,
        );
        expect(
          roundDouble(smoothedFastStochasticIndicator.getValue(22).quote, 2),
          80.55,
        );
        expect(
          roundDouble(smoothedFastStochasticIndicator.getValue(23).quote, 2),
          72.17,
        );
        expect(
          roundDouble(smoothedFastStochasticIndicator.getValue(24).quote, 2),
          69.25,
        );
        expect(
          roundDouble(smoothedFastStochasticIndicator.getValue(25).quote, 2),
          65.19,
        );
        expect(
          roundDouble(smoothedFastStochasticIndicator.getValue(26).quote, 2),
          54.23,
        );
        expect(
          roundDouble(smoothedFastStochasticIndicator.getValue(27).quote, 2),
          47.36,
        );
        expect(
          roundDouble(smoothedFastStochasticIndicator.getValue(28).quote, 2),
          49.36,
        );
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(
          roundDouble(slowStochasticIndicator.getValue(24).quote, 2),
          69.25,
        );
        expect(
          roundDouble(slowStochasticIndicator.getValue(25).quote, 2),
          65.19,
        );
        expect(
          roundDouble(slowStochasticIndicator.getValue(26).quote, 2),
          54.23,
        );
        expect(
          roundDouble(slowStochasticIndicator.getValue(27).quote, 2),
          47.36,
        );
        expect(
          roundDouble(slowStochasticIndicator.getValue(28).quote, 2),
          49.36,
        );
      },
    );
    test(
      ...
      () {
        ...
        expect(
          roundDouble(smoothedSlowStochasticIndicator.getValue(24).quote, 2),
          73.99,
        );
        expect(
          roundDouble(smoothedSlowStochasticIndicator.getValue(25).quote, 2),
          68.87,
        );
        expect(
          roundDouble(smoothedSlowStochasticIndicator.getValue(26).quote, 2),
          62.89,
        );
        expect(
          roundDouble(smoothedSlowStochasticIndicator.getValue(27).quote, 2),
          55.6,
        );
        expect(
          roundDouble(smoothedSlowStochasticIndicator.getValue(28).quote, 2),
          50.32,
        );
      },
    );
